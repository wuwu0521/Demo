...
public class CalendarUtil {
	 ...
	 * @return Date
	 */
	public static String getTimeString(String times,int days) {
		Calendar calendar = DateToCalendar(StringToDate(times));
	 ...
	 * @return Date
	 */
	public static String getTimeString(String times) {
		Calendar calendar = DateToCalendar(StringToDate(times));
		return DateToString(CalendarToDate(calendar));
	}
}
