...
public class TabletJPushClient {
	protected static final Logger LOG = LoggerFactory
			.getLogger(TabletJPushClient.class);

	private static final String APPKEY = "f5e09df339cf2ddd11ea16f6";
	private static final String MASTERSECRET = "daa94b18a1d7d4f2ad9a6cd7";
	

	private String title = "银盒子云POS";
	...
	public TabletJPushClient(String message, Map<String, String> map) {
	...
	public PushPayload buildPushObject_android_alias_alertWithTitle(
		...
		return PushPayload.newBuilder().setPlatform(Platform.android())
				.setAudience(Audience.alias(alias)).setNotification(
						Notification.android(message, title, extras)).build();
	}
