...
public class APPJPushClient {
	protected static final Logger LOG = LoggerFactory
			.getLogger(APPJPushClient.class);

	// demo App defined in resources/jpush-api.conf
	private static final String APPKEY = "cfd0ec84efa515da571eb308";
	private static final String MASTERSECRET = "2d2dfe30b5e63f4a164e7957";
	

	private String title = "便利宝商家版";
	...
	public APPJPushClient(String message, Map<String, String> map) {
